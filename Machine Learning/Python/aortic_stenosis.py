...
sql_query = pd.read_sql_query('SELECT * FROM SCHEMA.NLPFORAS_PROSPECTIVE',conn)
df = pd.DataFrame(sql_query, columns=['Findings_Value','AS_SEVERITY_OUTCOMES'])
